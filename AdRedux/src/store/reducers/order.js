...
import { purchaseBurgerFail, fetchOrdersSuccess } from '../actions/orders';
const initialState={
    orders:[],
    loading:false,
    purchased:false
...
const purchaseBurgersFail=(state,action)=>{
...
const reducer=(state=initialState,action)=>{
        switch(action.type){
            ...
            case actionTypes.PURCHASE_BURGER_FAIL:return purchaseBurgersFail(state,action);  
